    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if isUserArrive == false || indexPath.section != 0 {
            ...
            let action = UIAlertAction(title:"預約上車", style: .default) { (_) in
                ...
                let bookedView = self.storyboard?.instantiateViewController(withIdentifier: "bookView") as! BookedRouteViewController
                ...
                bookedView.finalStop = self.stops[self.sectionCount - 1]
